...
The `umc_packages_upgrade_security` role identifies and installs security upgrades.

The role captures the output of the upgrade process and extracts a summary line which is stored as a `_umc_global_upgrade_summary` host fact.
