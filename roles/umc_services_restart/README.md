...
The `umc_services_restart` role uses the `needrestart` utility to identify and restart services that require it (i.e. after package upgrades or other system changes).
